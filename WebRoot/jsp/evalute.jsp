    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<table width="650px" cellspacing="0" cellpadding="5" >
        		<tr bgcolor="#ddd">
        			<td width="120" align="left">图片</td>
        			<td width="120" align="left">名称</td>
        			<td width="120" align="left">厂家</td>
        			<td width="120" align="left">厂家</td>
        			<td width="120" align="left">评价</td>
        		</tr>
        		<c:forEach items="${evaluteinfo1 }" var="ef">
        		<tr >
        			<td><a href="showDetail.do?id=${ef.wine.wineId }"><img src="../images/image/${ef.wine.winePhoto }" alt="image 1" style="width:60px;height: 60px"/></a></td>
        			<td><a href="showDetail.do?id=${ef.wine.wineId }">${ef.wine.wineName }</a></td>
        			<td>${ef.wine.origin }</td>
        			<td>${ef.date }</td>
        			<td><a href="goevalute.do?evaluteid=${ef.evaluteId }">评价</a></td>
        		</tr>
        		</c:forEach>
        	</table>
