    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<table width="680px" cellspacing="0" cellpadding="5">
                     ...
                     <c:forEach items="${collectlist }" var="cf">
                         
                    	<tr>
                    		
                        	<td><a href="showDetail.do?id=${cf.wine.wineId }"><img src="../images/image/${cf.wine.winePhoto }" alt="image 1" style="width:50px;height:50px;"/></a></td> 
                        	<td><a href="showDetail.do?id=${cf.wine.wineId }">${cf.wine.wineName }</a></td> 
                            
                            <td align="right"><span id="wineprice">${cf.wine.winePrice } </span></td> 
                            <td align="center"> <a href="deletecollect.do?collectid=${cf.collectId }&&userid=${cf.user.userId}"><img src="../images/trash.png" alt="remove" /><br />Remove</a> </td>
