...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<img src="../images/touxiang/${sessionScope.userinfo.photo }" style="width:80px;heigth:80px" alt="头像" />
        	</div>
        	<div style="float: left;margin:25px 25px;">
        	<span style="font-size: 16px">用户名：${sessionScope.userinfo.userName}</span><br/><br/>
        	<span style="font-size: 16px">级&nbsp;&nbsp;&nbsp;别：${sessionScope.userinfo.userType}</span>
        	</div>
        	</div>
        	<form action="updateuserinfo.do" method="post">
        	<div style="float: left;margin-top:20px;margin-bottom: 20px;">
         	            收件地址:<br />
				<input type="text" name="address" value="${newuser.address}" style="width:300px;"  />
                <br />
                                                邮编:<br />
				<input type="text" name="youbian" value="${newuser.youbian}" style="width:300px;"  />
                <br />
            
            	联系电话：<br />
				<input type="text" name="phone" value="${newuser.phone}" style="width:300px;"  />
                <br /><br />
