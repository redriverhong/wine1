    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<table width="600px" cellspacing="0" cellpadding="5" >
        		<tr bgcolor="#ddd">
        			<td width="120" align="left">订单号</td>
        			<td width="120" align="left">支付状态</td>
        			<td width="120" align="left">查看</td>
        			<td width="120" align="left">删除</td>
        		</tr>
        		<c:forEach items="${orderlist }" var="ol">
        		<tr >
        			<td><a href="myorder.do?userid=${ol.user.userId }&&orderId=${ol.orderId}">${ol.orderId}</a></td>
        			<c:if test="${ol.payorno==1 }">
        			<td>已付款</td>
        			</c:if>
        			<c:if test="${ol.payorno==0 }">
        			<td>未付款</td>
        			</c:if>
        			<td><a href="myorder.do?userid=${ol.user.userId }&&orderId=${ol.orderId}">查看</a></td>
        			<td><a href="deleteorder.do?orderid=${ol.orderId }&&userid=${ol.user.userId }"><img src="../images/trash.png" alt="remove" /></a></td>
        		</tr>
        		</c:forEach>
        	</table>
